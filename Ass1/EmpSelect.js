...
function EmpSelect(){
  ...
  useEffect(()=>{
    ...
    {eid:102,name:'Rishabh',salary:45000,dept:"Tester"},
    {eid:103,name:'Purvi',salary:40000,dept:"Tester"},
    {eid:104,name:'Aboli',salary:55000,dept:"Web Development"},
    {eid:105,name:'Avisha',salary:30000,dept:"Admin"}];
